...
} from '@metamask/controllers/dist/transaction/TransactionController';
...
export const validateGasValues = (gasValues: GasPriceValue | FeeMarketEIP1559Values) => {
...
export const isGasPriceValue = (
  gasValues?: GasPriceValue | FeeMarketEIP1559Values,
): gasValues is GasPriceValue => (gasValues as GasPriceValue)?.gasPrice !== undefined;
